...
{\small\itshape
Unlike formulations based on quantum annealing or Rydberg
atoms~\cite{tabi2020}, and spatial mappings that use $N^2$
qubits by assigning one to each square~\cite{naik2018, nahimovs2023},
